        ...
        <html>
          <head>
            ...
            <style>
              ...
              .detail-label { font-weight: bold; width: 150px; color: #182136; }
          ...
          <body>
            ...
            <div class="detail-row">
              <div class="detail-label">Nº de Expediente:</div>
              <div class="detail-value">${tramite.nroExpediente}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Estado:</div>
              <div class="detail-value"><span class="status-badge">${tramite.estado}</span></div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Partido:</div>
              <div class="detail-value">${tramite.partido}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Partida:</div>
              <div class="detail-value">${tramite.partida}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Tipo de Trámite:</div>
              <div class="detail-value">${tramite.tipo_tramite}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Nomenclatura:</div>
              <div class="detail-value">${tramite.nomenclatura}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Fecha de Alta:</div>
              <div class="detail-value">${tramite.fecha_alta}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Fecha del Estado:</div>
              <div class="detail-value">${tramite.fecha_movimiento}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Origen:</div>
              <div class="detail-value">${tramite.origen}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Oblea:</div>
              <div class="detail-value">${tramite.oblea}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Demora:</div>
              <div class="detail-value">${tramite.demora}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Fecha Final Estimada:</div>
              <div class="detail-value">${tramite.final_estimada}</div>
            </div>
            <div class="detail-row">
              <div class="detail-label">Última Sincronización:</div>
              <div class="detail-value">${tramite.ultima_sincronizacion}</div>
            </div>
            <p class="timestamp">Generado: ${new Date().toLocaleString('es-AR')}</p>
          </body>
        </html>
      `;
    ...
    <Modal visible={visible} animationType="slide" transparent={false}>
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
          <View style={styles.expedienteSection}>
            ...
            <View style={[styles.statusBadge, { backgroundColor: getStatusColor(tramite.estado) }]}>
              <Text style={styles.statusText}>{tramite.estado}</Text>
            </View>
          </View>
        ...
        <View style={styles.actionButtons}>
          ...
          <TouchableOpacity style={[styles.button, styles.shareButton]} onPress={generatePDF}>
